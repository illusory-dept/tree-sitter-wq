...
module.exports = grammar({
  ...
  rules: {
    ...
    builtin: (_) =>
      choice(
        "abs","alloc","and","arccos","arccosh","arcsin","arcsinh","arctan","arctanh","asciiplot","atom?","band","bfn","bin","bnot","bool?","bor","bxor","cat","ceil","chr","cos","cosh","count","decode","depth","dict?","echo","encode","exec","exp","fclose","fexists?","flatten","floor","fmt","fn?","fread","freadt","freadtln","fseek","fsize","ftell","fwrite","fwritet","hash","hex","input","int","int?","intlist?","ints","iota","keys","list?","ln","log","log10","log2","m?","mkdir","neg","not","number?","oct","open","or","ord","print","println","raise","rand","reshape","reverse","rg","round","sgn","shape","shl","showt","shr","sin","sinh","sort","sqrt","str","str?","stream?","symbol","tan","tanh","type","typev","uniform?","unit?","where","xor"
      ),
